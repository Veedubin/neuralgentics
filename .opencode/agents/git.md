...
2. **Query memini-core** — For previous similar changes and commit message conventions
3. **Save when complete** — `memoryManager_add_memory` with commit details
...
Before committing, query memini-core for:
