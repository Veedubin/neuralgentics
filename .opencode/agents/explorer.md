---
description: Neuralgentics Explorer - Fast file finding using devstral-2:123b-cloud (Ollama Cloud) with memini-core semantic search.
mode: subagent
...
Use `memoryManager_search_project` for semantic code search:
