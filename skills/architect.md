...
3. Recommend the simplest viable option first, then discuss alternatives.
4. Ensure all proposed designs align with the current Neuralgentics hybrid TS/Python architecture.
